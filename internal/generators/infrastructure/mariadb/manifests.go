...
func createMariaDBManifests(generatorMeta generator.GeneratorMeta) map[string][]byte {
						...
						From: []networking.NetworkPolicyPeer{
							{
								...
								NamespaceSelector: meta.LabelSelector{
									MatchLabels: map[string]string{
										"kubernetes.io/metadata.name": "booklore",
									},
								},
							},
						},
	...
	return utils.MarshalManifests([]utils.ManifestConfig{namespace, kustomization, pvc, deployment, service, scaledObject, networkPolicy})
}
