...
func createReflectorManifests(generatorMeta generator.GeneratorMeta) map[string][]byte {
	...
	postgresSecretConfig := utils.StaticSecretConfig{
		...
		SecretAnnotations: map[string]string{
			"reflector.v1.k8s.emberstack.com/reflection-allowed":            "true",
			"reflector.v1.k8s.emberstack.com/reflection-allowed-namespaces": "postgres,mealie,jellyfin",
			"reflector.v1.k8s.emberstack.com/reflection-auto-enabled":       "true",
			"reflector.v1.k8s.emberstack.com/reflection-auto-namespaces":    "postgres,mealie,jellyfin",
		},
	}
