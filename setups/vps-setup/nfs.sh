...
sudo ufw allow in from 100.127.1.1/16 to any port 111
sudo ufw allow in from 100.127.1.1/16 to any port 2049
# 13025 <- this ports needs to be manually fixed, its usually dynamic
# change it in /etc/nfs.conf under [mountd]
sudo ufw allow in from 100.127.1.1/16 to any port 13025